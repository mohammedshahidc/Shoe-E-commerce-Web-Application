...
//     try {
//       const response = await axios.post("http://localhost:4004/api/user/createorder", {
//         headers:{
//           Authorizaiton:`Bearer ${curuser}`
//         }
//       }, {
//         withCredentials: true,
//       });
...
//               </div>
//               <Link  className="block bg-[#131842] mt-6 text-white px-4 py-2 rounded-lg hover:bg-gray-800 w-full md:w-auto text-center" onClick={createOrder} >
//                 Proceed to Checkout
//               </Link>
//             </div>
//           </div>
