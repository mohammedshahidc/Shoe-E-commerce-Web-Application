    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-400 to-blue-50">
        ...
        <div className="relative container mx-auto px-4 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-4xl mx-auto" data-aos="fade-up">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 leading-tight">
              Elevate Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Style</span>
            </h1>
            <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
              Premium Men's Footwear for Every Occasion
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12" data-aos="fade-up">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Men's Collection</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our curated selection of premium men's footwear designed for style and comfort
          </p>
